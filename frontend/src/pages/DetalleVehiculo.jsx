                    ...
                    <div style={estilos.desgloseBox}>
                      ...
                      {comision.reparto === 'vendedor' ? (
                        <>
                          ...
                          <div style={{ ...estilos.desgloseFila, color: 'var(--carbon-suave)', fontSize: '13px' }}><span>El vendedor recibiría (menos {comision.pct}%)</span><span>{fmtCOP(d.recibeVendedor)}</span></div>
                        </>
                      ) : (
                        <>
