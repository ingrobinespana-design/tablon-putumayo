...
export const MARCAS = {
  ...
  pesados: [
    ...
    'Chevrolet (NHR/NPR)', 'Marcopolo', 'Busscar', 'Nissan',
  ],
  agricola: [
  ...
  maquinaria: [
    ...
    'Kobelco', 'Terex', 'LiuGong', 'Sinotruk', 'Kubota',
  ],
};
...
export const LINEAS = {
  ...
  Renault: ['Twingo', 'Clio', 'Sandero', 'Sandero Stepway', 'Symbol', 'Logan', 'Stepway', 'Kwid', 'Kwid E-Tech', 'Duster', 'Duster Oroch', 'Captur', 'Koleos', 'Oroch', 'Alaskan', 'Kangoo', 'Kardian', 'Mégane', 'Fluence', 'Scénic', 'Trafic'],
  ...
  Volkswagen: ['Gol', 'Voyage', 'Polo', 'Virtus', 'Vento', 'Jetta', 'Passat', 'Golf', 'Scirocco', 'Beetle', 'T-Cross', 'Nivus', 'Taos', 'Tiguan', 'Touareg', 'Amarok', 'Saveiro', 'Crafter', 'Transporter'],
  ...
  Foton: ['Tunland', 'Aumark', 'Ollin', 'Auman', 'View', 'Toano', 'Gratour'],
  Dodge: ['Journey', 'Durango', 'Charger', 'Challenger', 'Ram'],
  RAM: ['700', '1000', '1500', '2500', '3500', '4000', '5500'],
  ...
  'Mercedes-Benz': ['Clase A', 'Clase B', 'Clase C', 'Clase E', 'Clase S', 'CLA', 'GLA', 'GLB', 'GLC', 'GLE', 'GLS', 'Clase G', 'Sprinter', 'Vito'],
  ...
  // ---- Maquinaria amarilla / agrícola: en su mayoría por referencia numérica → texto libre ----
  Caterpillar: ['320', '336', '420', '966', 'D6', 'D8', '140', '950'],
  Komatsu: ['PC200', 'PC300', 'D65', 'WA320', 'GD555'],
  JCB: ['3CX', '4CX', 'JS200', '426', 'Loadall'],
  'John Deere': ['5055', '5075', '5090', '6110', '310', '410', '644'],
};
